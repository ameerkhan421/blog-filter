...
function generatePost(post) {
    const returnPostDate = (date) => `${['Jan', 'Feb', 'Mar', 'Apr', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'] [date.getMonth()]} ${date.getDate()} ${date.getFullYear()}`;
    ...
    <div class="post__author">
      <img class="post__author--avatar" width="55" src="${post.meta.author.avatar}" alt="${post.user.name[0].firstName} ${post.user.name[1].lastName}"></div>
      <div>
